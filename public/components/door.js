...
async function fetchImages() {
    ...
    let response = await fetch('https://api.opensea.io/api/v1/assets?owner=0x087ce745cb7bde228c0fb5fcb855628f42c7d5b3&order_direction=desc&offset=0&limit=20', opt);
